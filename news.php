...
if($type == 2){
	...
	echo "[-] Token : $token \n";
    echo "[+] Kak wanda coba Redeem GOFOODSANTAI19 \n";
				...
				$claims19 = json_decode($claim19[0]);
					if($claims19->success == TRUE) {
						...
						echo "\n";
						sleep(6);
			echo "[+] Kak wanda coba Redeem COBAINGOJEK \n";
				...
				$claimscoba = json_decode($claimcoba[0]);
						...
						sleep(6);
			echo "[+] Kak wanda coba Redeem AYOCOBAGOJEK \n";
				...
				$claimsayo = json_decode($claimayo[0]);
						...
						echo "[-] Kak wanda gagal Claim GOFOODSANTAI19\n";
					}
	sleep(6);
	echo "[+] Kak wanda coba Redeem GOFOODSANTAI11 \n";
	...
	echo "[+] Process Redeem GOFOODSANTAI08 \n";
			...
			echo "[+] Process Redeem AYOCOBAGOJEK \n";
				...
				$claimsayo = json_decode($claimayo[0]);
						...
						echo "Kode OTP SALAH KAK!!!!!\n";
					}
		}else{
			echo "Nomor udah dipake kak\n";
		} 		
} #END TYPE DAFTAR
else if($type == 1){
